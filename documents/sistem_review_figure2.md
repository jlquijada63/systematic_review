# Figure 2 (CHARMS-PF) — Markdown table

Fuente: `documents/sistem_review.pdf` (Figure 2, paginas 11-12).

> Nota: las marcas se conservan como aparecen en el texto extraido (`X X`, `X X X`, `X`, etc.), ya que la alineacion de columnas en PDF a texto puede perderse.
